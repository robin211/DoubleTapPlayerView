...
import kotlinx.android.synthetic.main.double_tap_overlay.view.*
 ...
 * documentation ...).
 */
class DoubleTapOverlay(context: Context?, private val attrs: AttributeSet?) :
    ...
    val playerDoubleTapListener:PlayerDoubleTapListener
        get() = this
    ...
    override fun onAttachedToWindow() {
        ...
        if (playerViewRef != -1)
            playerView((this.parent as View).findViewById(playerViewRef) as PlayerView)
    }
     ...
     */
    fun playerView(playerView: PlayerView) = apply {
